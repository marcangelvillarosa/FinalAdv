...
const PostCard = ({uid, id, logo, name, email, text, image, timestamp, video}) => 
{
    ...
    return(
        <div className="flex w-[100%] items-center justify-center flex-col">
            ...
            <div className="w-[62.5%] flex flex-col justify-center items-center bg-white rounded-xl mb-5">
               
                <div className="w-[100%] h-20 p-3 pb-1 flex"> 
                   
                    <div className="flex justify-center items-center mr-2">
                        <Avatar className="bg-gray-500" variant="circular" src={logo || require("../pics/nickname.png")} alt="avatar"></Avatar>
                    </div>
